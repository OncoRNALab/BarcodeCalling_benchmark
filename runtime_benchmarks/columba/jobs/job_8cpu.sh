...
WORK_DIR="/user/gent/446/vsc44685/ScratchVO_dir/barcalling_review/work_runtime_columba/8cpu"
PARAMS_FILE="${PROJECT_DIR}/runtime_benchmarks/columba/params/params_8cpu.json"

echo "========================================="
echo "Columba Runtime Benchmark"
echo "Config: identity_threshold=77, cpus=8"
echo "Started: $(date)"
echo "========================================="
